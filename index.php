...
<body>
  ...
  <div class="produkt-pc">
    ...
    <div class="click-lager">
      <p class="click">Click & Collect | <img class="check-lager" src="images/check-icon.png" alt="Flueben"></p>
      <p class="lager">På lager online (100+) | <img class="check-lager" src="images/check-icon.png" alt="Flueben"></p>
      <hr class="hr-produkt">
